...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/-Vivado-E0232E?style=flat-square&logo=xilinx&logoColor=white" /> 
...
- 🥇 **National First Prize** · China Collegiate ICT Competition (2025.10)
- 🥈 **National Second Prize** · National Undergraduate Electronic Design Contest (2025.8)
- 🥈 **National Second Prize** · Blue Bridge Cup (FPGA Track) (2025.4)
- 🥉 **Second Prize** · Chuangkesheng Cup Electronic Design Contest
- 🥉 **First Prize (Provincial)** · TI Cup Electronic Design Contest

---

## 💻 Technical Stack

- **FPGA & Hardware** · Verilog · VHDL · HLS · Quartus · Vivado · DSP (TMS320F28335) · STM32
- **AI & Deep Learning** · PyTorch · TensorRT · ONNX · OpenCV · LLM Inference (vLLM · llama.cpp)
- **Programming** · Python · C++ · C · MATLAB · SystemVerilog
- **Tools & Platforms** · Linux · Docker · Git · CMake · Kubernetes · GitLab CI
- **Hardware Design** · JLCPCB EDA · Multisim · Altium Designer
